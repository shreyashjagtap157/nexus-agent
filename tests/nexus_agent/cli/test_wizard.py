...
class TestSetupWizard(unittest.TestCase):
    ...
    def test_wizard_collects_basic_settings(self, mock_detect):
        ...
        mock_detect.return_value = {"cpu": "Intel", "cpu_threads": 8, "ram_total": "16 GB", "ram_available": "8 GB", "gpu": "NVIDIA RTX 3060", "vram": "12 GB", "npu": "Not detected", "recommended_model_size": "7B-13B"}
