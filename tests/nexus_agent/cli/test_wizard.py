...
class TestSetupWizard(unittest.TestCase):
    def setUp(self):
        ...
        # ⚡ Bolt Optimization: mock hardware detection for all wizard tests to prevent
        # subprocess.TimeoutExpired failures in CI runners.
        self.patcher = patch("nexus_agent.llm.model_manager.ModelManager.detect_hardware")
        self.mock_detect_hardware = self.patcher.start()
        self.mock_detect_hardware.return_value = {"cpu": "Mock CPU", "ram": "16 GB"}
    ...
    def test_hardware_detection_integration(self):
        ...
        # Use the already patched mock from setUp
        self.mock_detect_hardware.return_value = {
            "cpu": "Intel",
            "cpu_threads": 8,
            "ram_total": "16 GB",
            "ram_available": "8 GB",
        ...
        with patch("nexus_agent.cli.wizard.save_user_config"):
            ...
            self.mock_detect_hardware.assert_called()
