"""RAG Search Tool — Offline repository semantic keyword search via SQLite FTS5 & code symbol matching."""  # noqa: E501  # noqa: E501
...
class RepositoryRAGTool(Tool):
    ...
    def parameters(self) -> dict[str, Any]:
        return {
            ...
            "reindex": {
                "type": "boolean",
                "description": "Force scan and rebuild of the repository FTS5 index before querying.",  # noqa: E501  # noqa: E501
            }
        }
    ...
    def _reindex_workspace(self) -> None:
        ...
        exclude_dirs = {".git", "node_modules", "venv", ".venv", "__pycache__", "build", "dist", ".nexus-agent"}  # noqa: E501  # noqa: E501
        exclude_extensions = {".png", ".jpg", ".jpeg", ".gif", ".ico", ".pdf", ".zip", ".tar", ".gz", ".exe", ".dll", ".pyc"}  # noqa: E501  # noqa: E501
                ...
                try:
                    ...
                    for idx, line in enumerate(lines):
                        ...
                        if symbol_name and symbol_type:
                            symbol_data.append((str(rel_path), symbol_name, symbol_type, line_num, line_num + 5))  # noqa: E501  # noqa: E501
                    ...
                    while i < len(lines):
                        ...
                        if chunk_text.strip():
                            chunk_data.append((str(rel_path), chunk_text, i + 1, i + len(chunk_lines)))  # noqa: E501  # noqa: E501
                    ...
                    if symbol_data:
                        conn.executemany(
                            "INSERT INTO code_symbols (file_path, symbol_name, symbol_type, start_line, end_line) "  # noqa: E501  # noqa: E501
                            "VALUES (?, ?, ?, ?, ?)",
                            symbol_data
                        )
                    if chunk_data:
        ...
        try:
            ...
            for sym in symbol_cursor:
                ...
                chunk_cursor = conn.execute(
                    "SELECT * FROM file_chunks WHERE file_path = ? AND start_line <= ? AND end_line >= ?",  # noqa: E501  # noqa: E501
