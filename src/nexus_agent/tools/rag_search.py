...
class RepositoryRAGTool(Tool):
    ...
    def _reindex_workspace(self) -> None:
        ...
        # PERFORMANCE OPTIMIZATION: Replaced inefficient os.walk with custom iter_files()
        # utility. The internal os.scandir implementation dramatically reduces object creation
        # overhead and speeds up filesystem indexing for large RAG datasets.
