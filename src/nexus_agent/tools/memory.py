...
class MemoryTool(Tool):
    ...
    def parameters(self) -> dict[str, Any]:
        return {
            ...
            "entry_id": {"type": "string", "description": "Memory ID", "required": False},
            "content": {"type": "string", "description": "Memory content", "required": False},
            "category": {"type": "string", "description": "Category label", "required": False},
            "limit": {"type": "integer", "description": "Max entries to return. Default 10", "required": False},
            "offset": {"type": "integer", "description": "Skip entries. Default 0.", "required": False},
        }
