...
class SearchFilesTool(Tool):
    ...
    def _iter_files(self, search_path: Path):
        """Lazily iterate files under search_path using os.scandir stack."""
        # ⚡ Bolt: Replaced recursive generator with an explicit stack to avoid recursion limits
        # and improve performance by avoiding intermediate Path objects during directory traversal.
