...
class LSPClientTool(Tool):
    ...
    def execute(self, action: str, file: str, line: int = 1,
        ...
        return f"Action '{action}' is not supported by the local fallback (no LSP server installed)."  # noqa: E501  # noqa: E501
    ...
    def _dispatch_lsp(
        ...
        if action == "references":
            result = client.request(
                ...
                {"textDocument": text_doc, "position": position, "context": {"includeDeclaration": True}},  # noqa: E501  # noqa: E501
            )
        ...
        if action == "format":
            ...
            return "Formatting edits available from the server. Apply via edit_file with the returned WorkspaceEdit."  # noqa: E501  # noqa: E501
    ...
    def _render_diagnostics(path: Path, diagnostics: list[dict[str, Any]],
        ...
        for d in diagnostics[:50]:
            ...
            lines.append(f"  [{sev_label}] line {line_no}, col {col_no}{tag}: {d.get('message', '').strip()}")  # noqa: E501  # noqa: E501
        return "\n".join(lines)
    ...
    def _render_symbols(symbols: Any) -> str:
        ...
        def flatten(items: list[dict[str, Any]], depth: int = 0) -> list[str]:
            ...
            for item in items:
                ...
                r = item.get("location", {}).get("range", {}) if "location" in item else item.get("range", {})  # noqa: E501  # noqa: E501
        ...
        return "### Document symbols:\n" + "\n".join(body) if body else "No symbols reported by the language server."  # noqa: E501  # noqa: E501
    ...
    def _run_diagnostics(self, path: Path, content: str) -> str:
        ...
        if path.suffix.lower() == ".py":
            try:
                ...
                return f"✅ Diagnostics OK! No syntax compile errors found in Python file: {path.name}"  # noqa: E501  # noqa: E501
            ...
            for idx, line in enumerate(content.splitlines()):
                ...
                for char_idx, char in enumerate(line):
                    ...
                    if char == "'":
                        ...
                        if not stack:
                            return f"❌ SYNTAX ERROR: Unexpected closing bracket '{char}' at line {idx + 1}, column {char_idx + 1}"  # noqa: E501  # noqa: E501
                        last_char, last_line, last_col = stack.pop()
                        if last_char != bracket_map[char]:
                            return f"❌ SYNTAX ERROR: Unmatched brackets: '{last_char}' opened at line {last_line} but closed with '{char}' at line {idx + 1}"  # noqa: E501  # noqa: E501
                    prev_char = char
            if stack:
                last_char, last_line, last_col = stack.pop()
                return f"❌ SYNTAX ERROR: Unclosed bracket '{last_char}' opened at line {last_line}, column {last_col + 1}"  # noqa: E501  # noqa: E501
