...
class BatchEditTool(Tool):
    ...
    def execute(self, edits: list[dict[str, str]]) -> str:
        ...
        for edit in edits:
            ...
            if "path" not in edit or "target_content" not in edit or "replacement_content" not in edit:  # noqa: E501
        ...
        try:
            ...
            for path in completed_paths:
                summary.append(f"  - Clean replacement completed: {path.relative_to(self.workspace)}")  # noqa: E501
            return (
