    ...
    def execute(self, **kwargs: Any) -> str:
        ...
        try:
            ...
            if self.provider:
                ...
                system = (
                    "You are a git expert. Analyze the provided git diff and output a single, perfect conventional "  # noqa: E501  # noqa: E501
                    "commit message. Use conventional commits formatting (e.g. feat: add task graph module, "  # noqa: E501  # noqa: E501
                    "fix: resolve context timeout issue, docs: update readme). Do NOT add extra explanations, "  # noqa: E501  # noqa: E501
...
class PRGeneratorTool(Tool):
    ...
    @property
    def description(self) -> str:
        return "Auto-generates a Pull Request title and technical summary describing branch changes."  # noqa: E501  # noqa: E501
    ...
    def execute(self, base_branch: str = "main", **kwargs: Any) -> str:
        try:
            ...
            if self.provider:
                system = (
                    "You are a principal engineer. Create a compelling, professional Pull Request title and description "  # noqa: E501  # noqa: E501
...
class CIAnalyzerTool(Tool):
    ...
    def execute(self, log_text: str, **kwargs: Any) -> str:
        ...
        for line in lines:
            if any(k in line.lower() for k in ["fail", "error", "exception", "traceback", "panic", "fatal"]):  # noqa: E501  # noqa: E501
                capture = True
                captured_lines = 0
        ...
        if self.provider:
            system = (
                "You are an expert DevOps engineer and debugger. Read the provided CI log output block. "  # noqa: E501  # noqa: E501
                "Diagnose exactly why the CI failed, highlight the root error file/line/context, and provide "  # noqa: E501  # noqa: E501
