...
async def websocket_endpoint(websocket: WebSocket, session_id: str):
    ...
    # ⚡ Sentinel: Explicit Origin vs Host validation to prevent Cross-Site WebSocket Hijacking (CSWSH)  # noqa: E501
    ...
    if origin and host_header:
        ...
        if parsed_origin != parsed_host:
            raise fastapi.WebSocketException(code=1008, reason="CSWSH check failed")
