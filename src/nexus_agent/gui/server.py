...
async def load_model(req: ModelLoadRequest):
    ...
    try:
        ...
        load_kwargs: dict[str, Any] = {}  # noqa: E701
        if req.gpu_layers is not None: load_kwargs["gpu_layers"] = req.gpu_layers  # noqa: E701
        if req.context_size is not None: load_kwargs["context_size"] = req.context_size  # noqa: E701
