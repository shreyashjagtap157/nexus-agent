...
async def websocket_endpoint(websocket: WebSocket, session_id: str):
    ...
    if origin and host_header:
        ...
        if origin_hostname and host_hostname and origin_hostname != host_hostname:
            logger.warning(f"CSWSH blocked: origin {origin_hostname} vs host {host_hostname}")
