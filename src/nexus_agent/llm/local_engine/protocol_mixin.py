...
class ProtocolMixin:
    ...
    def set_tool_result(
        self, tool_call_id: str, result: Any, success: bool = True, error: str | None = None
    ):  # noqa: E501
    ...
    def _execute_operations(
        ...
        for cmd in parser.get_commands():
            ...
            try:
                ...
                executed.append(
                    {"type": "command", "command": cmd.command_string, "result": result}
                )  # noqa: E501
                if self._protocol:
                    self._protocol.event_logger.log(
                        "command_executed", command=cmd.command_string, success=True
                    )  # noqa: E501
            except (
                RuntimeError,
                ValueError,
                ...
                if self._protocol:
                    self._protocol.event_logger.log(
                        "command_executed", command=cmd.command_string, success=False, error=str(e)
                    )  # noqa: E501
    ...
    def run_agent_loop(
        ...
        return {
            ...
            "thinking": [
                {"step": t.step, "observation": t.observation, "confidence": t.confidence}
