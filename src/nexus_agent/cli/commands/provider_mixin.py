...
class ProviderCommandsMixin:
    ...
    _PROVIDER_META = {
        "openai":       {"base": "https://api.openai.com/v1",              "env_key": "OPENAI_API_KEY"},  # noqa: E501
        "anthropic":    {"base": "https://api.anthropic.com/v1",           "env_key": "ANTHROPIC_API_KEY"},  # noqa: E501
        "google":       {"base": "https://generativelanguage.googleapis.com/v1beta/openai", "env_key": "GEMINI_API_KEY"},  # noqa: E501
        "ollama":       {"base": "http://localhost:11434",                 "env_key": ""},
        "openrouter":   {"base": "https://openrouter.ai/api/v1",          "env_key": "OPENROUTER_API_KEY"},  # noqa: E501
        "groq":         {"base": "https://api.groq.com/openai/v1",        "env_key": "GROQ_API_KEY"},  # noqa: E501
        "deepseek":     {"base": "https://api.deepseek.com/v1",           "env_key": "DEEPSEEK_API_KEY"},  # noqa: E501
        "bedrock":      {"base": "",                                      "env_key": ""},
        "nvidia":       {"base": "https://integrate.api.nvidia.com/v1",   "env_key": "NVIDIA_API_KEY"},  # noqa: E501
        "mistral":      {"base": "https://api.mistral.ai/v1",             "env_key": "MISTRAL_API_KEY"},  # noqa: E501
        "fireworks":    {"base": "https://api.fireworks.ai/inference/v1", "env_key": "FIREWORKS_API_KEY"},  # noqa: E501
        "together":     {"base": "https://api.together.xyz/v1",           "env_key": "TOGETHER_API_KEY"},  # noqa: E501
        "perplexity":   {"base": "https://api.perplexity.ai",             "env_key": "PERPLEXITY_API_KEY"},  # noqa: E501
        "custom":       {"base": "",                                      "env_key": ""},
    }
