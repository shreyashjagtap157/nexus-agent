...
SLASH_COMMANDS = [
    ...
    {"name": "/memory vector stats", "description": "Vector store statistics"},

    {"name": "/memory vector query", "description": "Semantic similarity search via embeddings"},

    {"name": "/memory vector migrate", "description": "Re-embed FTS5 memories"},


    {"name": "/memory vector download", "description": "Download ONNX embedding model"},
    ...
    {"name": "/explain", "description": "Verbalize strategies of the last step"},
