...
class AgentCommandsMixin:
    ...
    def _render_effort_selector(self, levels: tuple, labels: tuple, idx: int):
        ...
        lines = [
            ...
            "  Effort",
            "",
            f"{pad_str}Faster{' ' * (left_w - 6)}Smarter",
            f"{pad_str}{left_str}\u252c{right_str}",
        ]
    ...
    def _get_vector_store(self) -> "Any | None": # type: ignore
    ...
    def _get_memory_manager(self) -> "Any | None": # type: ignore
