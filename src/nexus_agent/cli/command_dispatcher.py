...
SLASH_COMMANDS = [
    ...
    {
        "name": "/update",
        "description": "Update NexusAgent to the latest version (pip install --upgrade)",
    },  # noqa: E501
    ...
    {
        "name": "/disconnect",
        "description": "Disconnect from current provider, return to local mode",
    },  # noqa: E501
    {
        "name": "/nla",
