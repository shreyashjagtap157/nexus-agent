...
def session_checkpoint(description: str) -> None:
    ...
    # ⚡ Bolt: Lazily evaluate rglob using islice to prevent loading thousands of files into memory  # noqa: E501
    files = [str(f) for f in itertools.islice(Path.cwd().rglob("*.py"), 20)]  # noqa: E501
