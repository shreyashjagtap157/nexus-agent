...
def session_checkpoint(description: str) -> None:
    ...
    # ⚡ Bolt: Use lazy consumption via islice instead of greedily evaluating the entire
    # generator into a list before slicing. This avoids massive memory overhead and
    # disk I/O when rglob scans large/deep directories, as it stops traversing
    # as soon as 20 matches are found.
