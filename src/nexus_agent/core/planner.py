...
Your sole responsibility is to analyze user requests and codebase contexts to create a highly precise, step-by-step Technical Implementation Plan.  # noqa: E501

You operate in READ-ONLY mode. You have access to tools that let you find, search, read, and list files and execute safe commands (like git status, pytest dry-runs).  # noqa: E501
...
4. **Verification Plan**: Step-by-step instructions on how the Executor should test and verify the changes.  # noqa: E501
...
"""
    ...
    def __init__(self, provider: LLMProvider, tools: list[Any], **agent_kwargs: Any):
        ...
        """
        self.read_only_tools = [t for t in tools if getattr(t, "permission_level", "dangerous") == "read-only"]  # noqa: E501
        ...
        cfg = AgentLoopConfig(mode=AgentMode.PLAN, system_prompt_extra=self.SYSTEM_PROMPT, **filtered_kwargs)  # noqa: E501
    ...
    def plan(self, task: str) -> AgentEvent:
        ...
        prompt = (
            ...
            f"\"\"\"\n{task}\n\"\"\"\n"
            f"First, gather necessary codebase context (list directories, read relevant code files) to understand "  # noqa: E501
