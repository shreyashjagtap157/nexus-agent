...
class PluginManager:
    ...
    def __init__(self, workspace: Path | None = None, plugin_dirs: list[Path] | None = None) -> None:  # noqa: E501
    ...
    def register_command(self, plugin_name: str, command_name: str, callback: Callable[[Any, str], None]) -> None:  # noqa: E501
    ...
    def register_tool(self, plugin_name: str, tool_instance: Any) -> None:
        ...
        if plugin_name in self.plugins:
            ...
            logger.info(f"Registered plugin tool: {getattr(tool_instance, 'name', type(tool_instance).__name__)} from {plugin_name}")  # noqa: E501
    ...
    def _load_file_plugin(self, file_path: Path) -> None:
        ...
        try:
            ...
            if not registered:
                info.error = "No entry point ('register_plugin' function or 'NexusPlugin' subclass) found."  # noqa: E501
                self.plugins[name] = info
    ...
    def _load_entry_points(self) -> None:
        ...
        if sys.version_info >= (3, 10):
            ...
            group = eps.get("nexus_agent.plugins", []) if hasattr(eps, "get") else eps.select(group="nexus_agent.plugins")  # noqa: E501
