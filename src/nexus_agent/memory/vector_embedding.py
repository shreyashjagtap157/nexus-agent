...
class EmbeddingEngine:
    ...
    def __init__(self, model_dir: str | Path | None = None):
        self._model_dir = Path(model_dir) if model_dir else Path.home() / ".nexus-agent" / "models" / "embeddings"  # noqa: E501
    ...
    def _embed_onnx(self, text: str) -> list[float]:
        ...
        try:
            ...
            token_type_ids = np.array([tokens.get("token_type_ids", [0] * len(tokens["input_ids"]))], dtype=np.int64)  # noqa: E501
